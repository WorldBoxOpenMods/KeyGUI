...
namespace KeyGUI.Menus.Localizations.Declarations {
  public class Locales : LocalesContainer {
    ...
    private static readonly Dictionary<LocaleDeclaration, string> DefaultLocales = new Dictionary<LocaleDeclaration, string>() {
      ...
      {KeyGui.Plots.WarSelectorInitiatorKingdomLabel, "Initiator Kingdom"},
      {KeyGui.Plots.WarSelectorTargetKingdomLabel, "Target Kingdom"},
      {KeyGui.Plots.RebellionSelectorInitiatorCityLabel, "Initiator City"},
      {KeyGui.Plots.AllianceCreationSelectorInitiatorKingdomLabel, "Initiator Kingdom"},
      {KeyGui.Plots.AllianceCreationSelectorTargetKingdomLabel, "Target Kingdom"},
      {KeyGui.Plots.AllianceJoinSelectorInitiatorKingdomLabel, "Initiator Kingdom"},
      {KeyGui.Plots.AllianceJoinSelectorTargetAllianceLabel, "Target Alliance"},
      {KeyGui.Plots.AllianceBreakSelectorInitiatorKingdomLabel, "Initiator Kingdom"},
      {KeyGui.Plots.AllianceBreakSelectorTargetAllianceLabel, "Target Alliance"},
      {KeyGui.Plots.TotalWarSelectorInitiatorKingdomLabel, "Initiator Kingdom"},
