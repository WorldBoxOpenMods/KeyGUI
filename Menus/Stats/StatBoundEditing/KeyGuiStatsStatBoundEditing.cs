...
namespace KeyGUI.Menus.Stats.StatBoundEditing {
  public class KeyGuiStatsStatBoundEditing : KeyGuiMenuManager {
    public readonly KeyGuiLocale EditStatSubmenuName = "Edit Stat";
    public readonly KeyGuiLocale ModifyStatButton = "Modify {0}";
    ...
    protected override void LoadGUI() {
      ...
      foreach (BaseStatAsset s in AssetManager.base_stats_library.list.Where(s => GUILayout.Button(string.Format(ModifyStatButton, s.id)))) {
    ...
    internal override void AddSubMenus() {
      Load<KeyGuiStatsStatBoundEditingEditStat>(EditStatSubmenuName);
    }
  }
}
