namespace KeyGUI.Menus.ModConfig.ConfigOptions {
  ...
  public abstract class General : General<object> {
    ...
    public static ConfigOption<bool> ShowDebugButton => new General<bool>("ShowDebugButton", false, "If true, KeyGUI will show the games debug button on startup.");
    public static ConfigOption<float> GuiScale => new General<float>("GuiScale", 1f, "The scale of the KeyGUI interface.") {Minimum = 0.25f, Maximum = 3f};
  }
}
